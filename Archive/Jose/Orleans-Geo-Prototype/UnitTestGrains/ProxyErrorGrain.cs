...
namespace ProxyErrorGrain
{
    ...
    //{
    //    AsyncCompletion ConnectTo(IErrorGrain errorGrain);
    //    AsyncCompletion SetAError(int a);
    //    AsyncValue<string> GetRuntimeInstanceId();
    //}

    public class ProxyErrorGrain : SimpleGrain.SimpleGrain, IProxyErrorGrain
    {
