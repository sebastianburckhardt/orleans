...
namespace BenchmarkGrains
{
    ...
    /// </summary>
    public class ChainedGrain : GrainBase<IChainedGrainState>, IChainedGrain
    {
        #region IChainedGrain Members



        Task<IChainedGrain> IChainedGrain.Next { get { return Task.FromResult(State.Next); } }

        Task<int> IChainedGrain.Id { get { return Task.FromResult(State.Id); } }

        Task<int> IChainedGrain.X { get { return Task.FromResult(State.X); } }
