...
using GeoOrleans.Runtime.OrleansPileus.ReplicatedGrains;

#pragma warning disable 1998

namespace GeoOrleans.Benchmarks.LeaderboardPileus.Grains
{

    // An implementation of the leaderboard based on sequenced updates.
    // all operations are synchronous

    public class DummySequencedLeaderboardGrain : GeoOrleans.Runtime.OrleansPileus.ReplicatedGrains.PileusSequencedGrain<DummySequencedLeaderboardGrain.State>, GeoOrleans.Benchmarks.LeaderboardPileus.Interfaces.IDummySequencedLeaderboardGrain
    {
        [Serializable]
