...
{
    // todo:[mlr] LocalPlacement implies stateless activations and these interfaces clearly describe something
    // that is expected to have state. it's breaking unit tests, so i'm going to remove this attribute for now.
    //[Strategies("LocalPlacement")]
