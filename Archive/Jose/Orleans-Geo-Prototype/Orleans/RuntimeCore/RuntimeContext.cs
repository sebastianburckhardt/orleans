...
namespace Orleans
{
    internal class RuntimeContext
    {
        ...
        internal static void InitializeThread(TaskScheduler scheduler = null)
        {
            // GK: REVIEW:
        ...
        internal static void SetExecutionContext(ISchedulingContext shedContext, TaskScheduler scheduler)
        {
            if (context == null)
            {
                throw new InvalidOperationException("SetExecutionContext called on unexpected non-WorkerPool thread");
            }
