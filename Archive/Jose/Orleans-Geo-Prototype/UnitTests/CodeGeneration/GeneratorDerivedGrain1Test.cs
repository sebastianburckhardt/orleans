...
namespace UnitTests
{
    ...
    /// </summary>
    [TestClass]
    public class GeneratorDerivedGrain1Test : UnitTestBase
    {
        const int timeout = 10000;
 
        IGeneratorTestDerivedGrain1 grain;
        //ResultHandle result;

        public GeneratorDerivedGrain1Test()
        {
            //
        ...
        public void GeneratorDerivedGrain1ControlFlow()
        {
            grain = GeneratorTestDerivedGrain1Factory.GetGrain(GetRandomGrainId());
