...
{
    [TestClass]
    public class TaskSchedulerPerfTests
    {
        ...
        public void Task_MultiSyncContext()
        {
            ...
            TaskSchedulingXCG.TimeRun(1, baseline, testName, () =>
            {
                for (int i = 0; i < numTasks; i++)
                {
                    Task t = CreateTask(i);
        ...
        public void Task_OrleansTaskScheduler()
        {
            ...
            TaskScheduler taskScheduler = OrleansTaskScheduler.InitializeSchedulerForTesting(rootContext);
        ...
        //[TestMethod]
        //public void Task_MultiOrleansWgTaskScheduler()
        //{
        //    string testName = "Task_MultiOrleansWgTaskScheduler";

        //    var baseline = DoBaseTestRun(testName + "-Baseline", numTasks);

        //    var tasks = new List<Task>(numTasks);

        //    object rootContext = new object();

        //    OrleansTaskScheduler  masterScheduler = OrleansTask.InitializeSchedulerForTesting(rootContext);
        //    TaskScheduler[] schedulers = new TaskScheduler[numTasks];
        //    for (int i = 0; i < numTasks; i++)
        //    {
        //        schedulers[i] = new WorkItemGroup(masterScheduler, i.ToString());
        //    }
        ...
        //        for (int i = 0; i < numTasks; i++)
        //        {
        //            Task t = CreateTask(i, i.ToString());
        //            t.Start(schedulers[i]);
        //            tasks.Add(t);
        //        }
        ...
        private static TimeSpan DoBaseTestRun(string runName, int numberOfTasks, TaskScheduler taskScheduler = null)
        {
            ...
            var baseline = TaskSchedulingXCG.TimeRun(1, TimeSpan.Zero, runName, () =>
            {
