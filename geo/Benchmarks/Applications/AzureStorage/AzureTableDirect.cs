...
namespace GeoOrleans.Benchmarks.Azure
{
    ...
    public class AzureTableDirect : IScenario
    {
        ...
        public String RobotServiceEndpoint(int workernumber)
        {
            ...
            return GeoOrleans.Benchmarks.Common.Endpoints.GetDefaultService();
        ...
        {
            System.Console.Write("PARAMETERS {0} \n", parameters);
                ...
                switch (nextOp)
                {
                    case AzureUtils.OperationType.READ:
                        ...
                        totReads++;
                            ...
                            if (b != null)
                            {
                                System.Console.Write("READ: {0} {1} {2} ", b.PartitionKey, b.RowKey, Encoding.ASCII.GetString(b.payload));
                            }
                    ...
                    case AzureUtils.OperationType.UPDATE:
                        ...
                        System.Console.Write("UPDATE: {0} {1} {2} ", nextEntity.PartitionKey, nextEntity.RowKey, Encoding.ASCII.GetString(nextEntity.payload));
