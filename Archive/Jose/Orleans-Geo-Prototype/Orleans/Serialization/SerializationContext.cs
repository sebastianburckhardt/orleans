...
namespace Orleans.Serialization
{
    ...
    public class SerializationContext
    {
        ...
        private struct Record
        {
            ...
            public Record(object original, object copy)
            {
                Copy = copy;
                Offset = 0;
            }

            public Record(object original, int offset)
            {
                Copy = null;
                Offset = offset;
            }
        ...
        public void RecordObject(object original, object copy)
        {
            ...
            {
                processedObjects[original] = new Record(original, copy);                
            }
        }

        internal void RecordObject(object original, int offset)
        {
            processedObjects[original] = new Record(original, offset);
        }
