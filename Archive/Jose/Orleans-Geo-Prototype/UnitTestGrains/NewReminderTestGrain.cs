...
namespace UnitTestGrains
{
        ...
        INewReminderTestGrain, IRemindable
    {
        ...
        private OrleansLogger logger = null;
        ...
        private void ApplyIfLogging(Action<OrleansLogger> logAction)
        {
        ...
        {
            ApplyIfLogging(l => l.Info("NewReminderTestGrain.ActivateAsync()"));
        ...
        {
            ApplyIfLogging(l => l.Info("NewReminderTestGrain.DeactivateAsync()"));
            return Task.FromResult(0);
        }
    }
}
