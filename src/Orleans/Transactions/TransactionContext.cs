...
namespace Orleans.Transactions
{
    ...
    public class TransactionInfo
    {
        public TransactionInfo(long id, bool readOnly = false)
        {
            ...
            IsAborted = false;
            PendingCalls = 0;
            ReadSet = new Dictionary<ITransactionalUnit, TransactionalUnitVersion>();
            WriteSet = new Dictionary<ITransactionalUnit, int>();
        ...
        public Dictionary<ITransactionalUnit, TransactionalUnitVersion> ReadSet { get; private set; }
        public Dictionary<ITransactionalUnit, int> WriteSet { get; private set; }
    ...
    public struct TransactionalUnitVersion : IEquatable<TransactionalUnitVersion>
    {
        public long TransactionId;
        public int WriteNumber;

        #region operators
        public static bool operator ==(TransactionalUnitVersion v1, TransactionalUnitVersion v2)
        {
        ...
        public bool Equals(TransactionalUnitVersion other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is TransactionalUnitVersion && Equals((TransactionalUnitVersion) obj);
        }
