...
namespace Orleans.LogConsistency
{
    ...
    public interface ILogConsistentGrain 
    {
        ...
        void InstallAdaptor(ILogViewAdaptorFactory factory, object state, string grainTypeName, IStorageProvider storageProvider, IProtocolServices services);
    ...
    public class LogConsistentGrainBase<TView> : Grain
    {
        ...
        public LogConsistentGrainBase(IGrainIdentity identity, IGrainRuntime runtime) : base(identity, runtime)
        { }
