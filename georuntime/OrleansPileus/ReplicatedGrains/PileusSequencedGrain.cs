...
using OrleansPileus.Common;
using OrleansPileus.Interfaces;
...
namespace OrleansPileus.ReplicatedGrains
{
        ...
        where StateObject : class, new()
    {
        ...
        protected OrleansPileus.Interfaces.IConfigurator configuratorLocalGrain = null;
        ...
        protected OrleansPileus.Interfaces.IConfigurator configuratorGlobalGrain = null;
        ...
        protected async Task initialiseGrain()
        {
            try
            {
                ...
                configuratorLocalGrain = OrleansPileus.Interfaces.ConfiguratorFactory.GetGrain(localContainerName);
                configuratorGlobalGrain = OrleansPileus.Interfaces.ConfiguratorFactory.GetGrain(globalContainerName);
