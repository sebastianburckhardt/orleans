...
namespace Orleans
{
    internal static class InternerConstants
    {
        ...
        36,700,157
        */
        public static readonly int Size_Small = 67;
        public static readonly int Size_Medium = 1117;
        public static readonly int Size_Large = 143357;
        public static readonly int Size_XLarge = 2293757;
    ...
    internal class Interner<K, T> where T : class
    {
        ...
        public Interner(int initialSize, TimeSpan cleanupFreq)
        {
            ...
            logger = Logger.GetLogger(internCacheName, Logger.LoggerType.Runtime);
        ...
        private void InternCacheCleanupTimerCallback(object state)
        {
            ...
            if (numRemoved>0)
                if (logger.IsInfo) logger.Info(ErrorCode.Runtime_Error_100296, "Removed {0} / {1} unused {2} entries in {3}", numRemoved, numEntries, internCacheName, clock.Elapsed);
            else
