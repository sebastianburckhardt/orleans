...
namespace UnitTestGrainInterfaces
{
    ...
    public class LargeTestData
    {
        ...
        public TestEnum EnumValue { get; set; }
        private ClassWithEnumTestData[] classArray;
    ...
    public interface IValueTypeTestGrain : IGrain
    {
        Task<ValueTypeTestData> StateData { get; }
    ...
    public interface IEnumResultGrain : IGrain
    {
        Task<CampaignEnemyTestType> GetEnemyType();

        Task<OrleansConfiguration> GetConfiguration();
    }
