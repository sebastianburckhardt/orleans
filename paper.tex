...
\lstset{language=Java
       ...
       ,keywords={entity,array,property,state,relation,function,var,orderby,match,with,not,global,%
                  ...
                  class,if,else,while,return,delegate,foreach,in,try,finally,static,threadlocal,private,public,atomic,assert,ref,true,false,with,struct,method,type,const,null,%
