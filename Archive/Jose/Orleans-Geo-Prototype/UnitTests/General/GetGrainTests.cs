...
namespace UnitTests
{
    ...
    public class GetGrainTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Nightly"), TestCategory("General"), TestCategory("GetGrain")]
        ...
        [TestMethod, TestCategory("Nightly"), TestCategory("General"), TestCategory("GetGrain")]
