...
namespace UnitTests.SerializerTests
{
    ...
    public class CustomSerializerTests
    {
        ...
        {
            Assert.IsNotNull(SerializationManager.GetSerializer(typeof(SerializerTestClass4)), "No serializer generated for return type of AsyncValue grain method");
        }

        [TestMethod, TestCategory("Serialization")]
        public void Serialize_GrainMethodAsyncParamType()
        {
            Assert.IsNotNull(SerializationManager.GetSerializer(typeof(SerializerTestClass5)), "No serializer generated for parameter type of AsyncValue grain method");
        }

        [TestMethod, TestCategory("Serialization")]
        public void Serialize_GrainMethodAsyncReturnOnlyType()
        {
            Assert.IsNotNull(SerializationManager.GetSerializer(typeof(SerializerTestClass6)), "No serializer generated for return type of parameterless AsyncValue grain method");
        }
    }
}
