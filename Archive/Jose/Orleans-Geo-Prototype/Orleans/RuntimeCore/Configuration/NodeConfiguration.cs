...
namespace Orleans
{
    ...
    public class NodeConfiguration : ITraceConfiguration, IStatisticsConfiguration, ILimitsConfiguration
    {
        ...
        private IPAddress Address { get { return OrleansConfiguration.ResolveIPAddress(HostNameOrIPAddress, Subnet, AddressType); } }
        ...
        internal string WorkingStorageDirectory
        {
            get
            {
                if (workingStoreDir == null)
                {
                    workingStoreDir = GetDefaultWorkingStoreDirectory();
                }
                return workingStoreDir;
            }
            set { this.workingStoreDir = value; }
        }
        ...
        private static readonly int DEFAULT_MIN_DOT_NET_THREAD_POOL_SIZE = 200;
        ...
        public NodeConfiguration(NodeConfiguration other)
        {
            ...
            TraceLevelOverrides = new List<Tuple<string, OrleansLogger.Severity>>();
            TraceLevelOverrides.AddRange(other.TraceLevelOverrides);
        ...
        public override string ToString()
        {
            ...
            //sb.Append("   Working storage directory: ").Append(WorkingStorageDirectory).AppendLine();
        ...
        {
            if (root.LocalName.Equals("Override"))
            {
                SiloName = root.GetAttribute("Node");
            }
            else
            {
                SiloName = DEFAULT_NODE_NAME;
            }
