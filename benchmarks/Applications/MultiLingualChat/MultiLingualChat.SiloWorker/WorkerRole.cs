...
namespace MultiLingualChat.SiloWorker
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("MultiLingualChat.SiloWorker is running");
        ...
        public override bool OnStart()
        {
            ...
            Trace.TraceInformation("MultiLingualChat.SiloWorker has been started");
        ...
        {
            Trace.TraceInformation("MultiLingualChat.SiloWorker is stopping");
            ...
            Trace.TraceInformation("MultiLingualChat.SiloWorker has stopped");
        }
