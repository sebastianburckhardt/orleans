    ...
    class Simulator : IConductorContext
    {
        ...
        public Simulator(IEnumerable<string> servers, int numrobots, IBenchmark benchmark, IScenario scenario)
        {
            ...
            while (robotnum < numrobots)
                ...
                {
                    robotclients.Add(new GeoOrleans.Benchmarks.Client(server, testname, robotnum++, Trace));
        ...
        List<GeoOrleans.Benchmarks.Client> robotclients = new List<GeoOrleans.Benchmarks.Client>();
