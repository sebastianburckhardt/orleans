...
namespace UnitTestGrains
{
    ...
    internal class AppDomainTestGrain : GrainBase, IAppDomainTestGrain
    {
        ...
        public override Task ActivateAsync()
        {
            ...
            {
                logger.Error(0, "Exception during ActivateAsync {0}", exc);
                throw;
            }
        }
    ...
    internal class AppDomainHostTestGrain : GrainBase, IAppDomainHostTestGrain
    {
        private readonly OrleansLogger logger;
