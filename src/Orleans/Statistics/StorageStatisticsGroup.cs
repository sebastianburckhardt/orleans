...
namespace Orleans.Runtime
{
    internal class StorageStatisticsGroup
    {
        ...
        internal static void OnStorageActivate(string grainType, GrainReference grain, TimeSpan latency)
        {
        ...
        internal static void OnStorageActivateError(string grainType, GrainReference grain)
        {
