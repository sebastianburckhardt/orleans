...
namespace Orleans.Runtime.GrainDirectory
{
    ...
    internal class ActivationInfo : IActivationInfo
    {
        ...
        {
            this.SiloAddress = iActivationInfo.SiloAddress;
            this.TimeCreated = iActivationInfo.TimeCreated;
        }
    ...
    internal class GrainDirectoryPartition
    {
        ...
        internal virtual void AddActivation(GrainId grain, ActivationId activation, SiloAddress silo)
        {
            if (!IsValidSilo(silo))
            {
                return;
        ...
        /// <param name="activation"></param>
        /// <param name="silo"></param>
        internal virtual ActivationAddress AddSingleActivation(GrainId grain, ActivationId activation, SiloAddress silo)
        {
