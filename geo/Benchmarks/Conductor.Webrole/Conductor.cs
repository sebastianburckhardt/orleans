...
namespace GeoOrleans.Benchmarks.Conductor.Webrole
{
    public class Conductor : IConductorContext
    {
        ...
        public GeoOrleans.Benchmarks.Console console;
        ...
        private void Run()
        {
            ...
            {   
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    Broadcast("Result", result + " " + GeoOrleans.Benchmarks.Common.Util.PrintStats(overallstats));
        ...
        public async Task<string> RunRobot(int robotnumber, string parameters)
        {
            ...
            GeoOrleans.Runtime.Common.Util.Assert(robot.promise == null);
