...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <p id="InputSpace">
                <asp:Button ID="ButtonSayHello" runat="server" Text="Ask Environment Grain" 
                    onclick="ButtonSayHello_Click" />
                <asp:Button ID="ButtonSayHelloSingleInstance" runat="server" Text="Ask Global-Single-Instance Environment Grain" 
                    onclick="ButtonSayHelloSingleInstance_Click" />
            </p>
            <p id="ReplySpace">
