...
namespace GeoOrleans.Benchmarks.Leaderboard.Grains
{
    ...
    public class SequencedLeaderboardGrain : SequencedGrain<SequencedLeaderboardGrain.State>, GeoOrleans.Benchmarks.Leaderboard.Interfaces.ISequencedLeaderboardGrain
    {
        [Serializable]
