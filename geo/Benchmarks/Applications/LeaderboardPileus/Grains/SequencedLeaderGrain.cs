...
namespace GeoOrleans.Benchmarks.LeaderboardPileus.Grains
{
    ...
    public class SequencedLeaderboardGrain : GeoOrleans.Runtime.OrleansPileus.ReplicatedGrains.PileusSequencedGrain<SequencedLeaderboardGrain.State>, GeoOrleans.Benchmarks.LeaderboardPileus.Interfaces.ISequencedLeaderboardGrain
    {
        [Serializable]
