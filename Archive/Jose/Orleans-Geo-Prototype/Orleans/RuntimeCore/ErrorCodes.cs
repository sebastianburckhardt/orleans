...
namespace Orleans
{
    ...
    internal enum ErrorCode
    {
        ...
        Runtime_Error_100313 = Runtime + 313,
        Runtime_Error_100314 = Runtime + 314,
        ...
        Runtime_Error_100322 = Runtime + 322,
        ...
        SiloFailedToStopMBR             = SiloBase + 19,
        ...
        Catalog_ShutdownActivations     = CatalogBase + 9,
        ...
        MBRBase                         = Runtime + 600,
        MBRCantWriteLivenessDisabled    = Runtime_Error_100225, // Backward compatability
        MBRNodeMigrated                 = MBRBase + 1,
        MBRNodeRestarted                = MBRBase + 2,
        MBRStarting                     = MBRBase + 3,
        MBRBecomeActive                 = MBRBase + 4,
        MBRFinishBecomeActive           = MBRBase + 5,
        MBRShutDown                     = MBRBase + 6,
        MBRStop                         = MBRBase + 7,
        MBRReadTable                    = MBRBase + 8,
        MBRKillMyself                   = MBRBase + 9,
        MBRVotingForKill                = MBRBase + 10,
        MBRMarkingAsDead                = MBRBase + 11,
        MBRWatchList                    = MBRBase + 12,
        MBRMissedPing                   = MBRBase + 13,
        MBRSendingPreJoinPing           = MBRBase + 14,
        MBRFailedToWrite                = MBRBase + 15,
        MBRFailedToWriteConditional     = MBRBase + 16,
        MBRFoundMyselfDead1             = MBRBase + 17,
        MBRFoundMyselfDead2             = MBRBase + 18,
        MBRDetectedOlder                = MBRBase + 19,
        MBRDetectedNewer                = MBRBase + 20,
        MBRDelayedTableUpdateTimer      = MBRBase + 21,
        MBRDelayedProbeOtherSilosTimer  = MBRBase + 22,
        MBRFailedToReadSilo             = MBRBase + 23,
        MBRDelayedIAmAliveUpdateTimer   = MBRBase + 24,
        MBRMissedIAmAliveTableUpdate    = MBRBase + 25,
        MBRLocalSubscriberException     = MBRBase + 26,
        MBRKillMyselfLocally            = MBRBase + 27,
        MBRFoundMyselfDead3             = MBRBase + 28,
        MBRMarkDeadWriteFailed          = MBRBase + 29,
        MBRTableGrainInit1              = MBRBase + 30,
        MBRTableGrainInit2              = MBRBase + 31,
        MBRTableGrainInit3              = MBRBase + 32,
        MBRTableGrainInit4              = MBRBase + 33,
        MBRReadAll_1                    = MBRBase + 34,
        MBRFactory1                     = MBRBase + 35,
        MBRFactory2                     = MBRBase + 36,
        MBRGrainBasedTable1             = MBRBase + 37,
        MBRGrainBasedTable2             = MBRBase + 38,
        MBRGrainBasedTable3             = MBRBase + 39,
        MBRFileBasedTable1              = MBRBase + 40,
        MBRFileBasedTable2              = MBRBase + 41,
        MBRFileBasedTable3              = MBRBase + 42,
        MBRFileBasedTable4              = MBRBase + 43,
        MBRPingedSiloNotInWatchList     = MBRBase + 44,
        MBRReadAll_2                    = MBRBase + 45,
        MBRFailedToStart                = MBRBase + 46,
        MBRFailedToBecomeActive         = MBRBase + 47,
        MBRFailedToStop                 = MBRBase + 48,
        MBRFailedToShutdown             = MBRBase + 49,
        MBRFailedToKillMyself           = MBRBase + 50,
        MBRFailedToSuspect              = MBRBase + 51,
        MBRReadAll_Cleanup              = MBRBase + 52,
        MBRShutDownFailure              = MBRBase + 53,
        MBRKillMyselfFailure            = MBRBase + 54,
        MBRGossipProcessingFailure      = MBRBase + 55,
        MBRGossipSendFailure            = MBRBase + 56,
        MBRTimerProcessingFailure       = MBRBase + 57,
        MBRSendPingFailure              = MBRBase + 58,
        MBRMergeColumnFailure          = MBRBase + 59,
        MBRStartingIAmAliveTimer        = MBRBase + 60,

        NSMBRStarting                   = MBRBase + 70,
        NSMBRBecomeActive               = MBRBase + 71,
        NSMBRFailedToBecomeActive       = MBRBase + 72,
        NSMBRShutDown                   = MBRBase + 73,
        NSMBRStop                       = MBRBase + 74,
        NSMBRKillMyself                 = MBRBase + 75,
        NSMBRKillMyselfLocally          = MBRBase + 76,
        NSMBRNotificationProcessingFailure = MBRBase + 77,
        NSMBRReadAll_1                  = MBRBase + 78,
        NSMBRReadAll_2                  = MBRBase + 79,
        NSMBRFoundMyselfDead2           = MBRBase + 80,
        NSMBRDetectedOlder              = MBRBase + 81,
        NSMBRDetectedNewer              = MBRBase + 82,
        NSMBRTimerProcessingFailure     = MBRBase + 83,
        NSMBRShutDownFailure            = MBRBase + 84,
        NSMBRKillMyselfFailure          = MBRBase + 85,
        NSMBRNSDetails                  = MBRBase + 86,
        ...
        ProxyClient_CreatedGwUnordered              = ProxyClientBase + 15,
        ProxyClient_CreatedGwToGrain                = ProxyClientBase + 16,
        ...
        DirectoryReplicaFromUnexpectedSilo      = DirectoryBase + 3,
        ...
        CRP_Add_MyIndexNotFound                 = ConsistentRingProviderBase + 2,
        CRP_Remove_MyIndexNotFound              = ConsistentRingProviderBase + 3,
        CRP_ForGrains_Local_Subscriber_Exception = ConsistentRingProviderBase + 4,
        ...
        AzureQueueStreamPullingAgentBase = Runtime + 3300,
        AzureQueueStream_Agent_01 = AzureQueueStreamPullingAgentBase + 1,
        AzureQueueStream_Agent_02 = AzureQueueStreamPullingAgentBase + 2,
        AzureQueueStream_Agent_03 = AzureQueueStreamPullingAgentBase + 3,
        AzureQueueStream_Agent_04 = AzureQueueStreamPullingAgentBase + 4,
        AzureQueueStream_Agent_05 = AzureQueueStreamPullingAgentBase + 5,
