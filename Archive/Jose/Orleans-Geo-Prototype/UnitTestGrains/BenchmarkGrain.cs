...
namespace UnitTestGrains
{
    ...
    public class BenchmarkGrain : GrainBase<IBenchmarkGrainState>, IBenchmarkGrain
    {
        Task<string> IBenchmarkGrain.Name { get { return Task.FromResult(State.Name); } }

        Task<IBenchmarkGrain> IBenchmarkGrain.Other { get { return new AsyncValue<IBenchmarkGrain>(State.Other).AsTask(); } }

        Task<int> IBenchmarkGrain.DummyDelay { get { return Task.FromResult(State.DummyDelay); } }
        ...
        //public Task<double> IntergrainBenchmarkReflected(IBenchmarkGrain other, int numIterations, int numDropIterations, string functionName, object[] data)
        //{
        ...
        //        AsyncCompletion promise = (AsyncCompletion)method.Invoke(other, data);
        //        promise.Wait();
        //    }
        //    s.Stop();
        //    double timeActual = s.Elapsed.TotalMilliseconds / numIterations;
        //    return Task.FromResult(timeActual);
        //}
        ...
        public async Task<TimeSpan> PromiseOverhead(int numIterations, int lenght, bool asynch)
        {
            ...
            if (asynch)
            {
                ...
                {
                    stopwatch.Start();
                    AsyncCompletion promise = AsyncCompletion.StartNew(() => { Foo(lenght); });
    ...
    [Reentrant]
    public class ThreadRingGrain : GrainBase, IThreadRingGrain
    {
