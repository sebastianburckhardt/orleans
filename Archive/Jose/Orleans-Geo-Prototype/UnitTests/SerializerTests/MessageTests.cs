...
namespace UnitTests.SerializerTests
{
    ...
    public class MessageTests
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Nightly"), TestCategory("Messaging")]
        ...
        private static void RunTest()
        {
            ...
            Assert.AreEqual<int>(1000, responseList.Count, "Body list has wrong number of entries");
            for (int k = 0; k < 1000; k++)
            {
