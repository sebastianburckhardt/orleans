...
namespace GeoOrleans.Benchmarks.LeaderboardPileus.Benchmark
{
    ...
    public class HttpRequestPersistentLeaderboard : IHttpRequest
    {
        ...
        public async Task<string> ProcessRequestOnServer()
        {
            ...
            using (new GeoOrleans.Runtime.Common.TraceInterval("Leaderboard FE - getgrain", 0))
            {
            ...
            if (requestType == LeaderboardRequestT.GET_SYNC)
            {
                ...
                using (new GeoOrleans.Runtime.Common.TraceInterval("Leaderboard FE - get - sync", 1))
                {
