...
namespace Orleans
{
    ...
    /// Instaces of a class implementing this should be added to <see cref="Logger.LogConsumers"/> collection in order to retrieve events.
    /// </summary>
    ...
    /// Instances of a class implementing this should be added to <see cref="Logger.LogConsumers"/> collection in order to retrieve events.
    /// </summary>
