...
namespace UnitTestGrains
{
    ...
    [StorageProvider(ProviderName = "test1")]
    public class PersistenceTestGrain : GrainBase<IPersistenceTestGrainState>, IPersistenceTestGrain
    {
        ...
        {
            IStorageProvider storageProvider = _Data.StorageProvider;
    ...
    [StorageProvider(ProviderName = "ErrorInjector")]
    public class PersistenceProviderErrorGrain : GrainBase<IPersistenceTestGrainState>, IPersistenceProviderErrorGrain
    {
        public override Task ActivateAsync()
        {
            return TaskDone.Done;
    ...
    [StorageProvider(ProviderName = "ErrorInjector")]
    public class PersistenceUserHandledErrorGrain : GrainBase<IPersistenceTestGrainState>, IPersistenceUserHandledErrorGrain
    {
        public override Task ActivateAsync()
        {
            return TaskDone.Done;
    ...
    [StorageProvider(ProviderName = "test1")]
    public class PersistenceErrorGrain : GrainBase<IPersistenceTestGrainState>, IPersistenceErrorGrain
    {
        public override Task ActivateAsync()
        {
            return TaskDone.Done;
    ...
    [StorageProvider(ProviderName = "MissingProvider")]
    public class BadProviderTestGrain : GrainBase<IPersistenceTestGrainState>, IBadProviderTestGrain
    {
        ...
        public override Task ActivateAsync()
        {
            GetLogger().Warn(1, "ActivateAsync");
            return TaskDone.Done;
        }
    ...
    [StorageProvider(ProviderName = "test1")]
    public class PersistenceNoStateTestGrain : GrainBase, IPersistenceNoStateTestGrain
    {
        ...
        public override Task ActivateAsync()
        {
            GetLogger().Info(1, "ActivateAsync");
            return TaskDone.Done;
        }
    ...
    public class AzureStorageTestGrain : GrainBase<IPersistenceTestGrainState>, 
    ...
    [StorageProvider(ProviderName = "AzureStore")]
    public class AzureStorageGenericGrain<T> : GrainBase<IPersistenceGenericGrainState<T>>,
    ...
    [StorageProvider(ProviderName = "AzureStore")]
    public class AzureStorageTestGrainExtendedKey : GrainBase<IPersistenceTestGrainState>,
    ...
    //[StorageProvider(ProviderName = "AzureStorageEmulator")]
    public class MemoryStorageTestGrain : GrainBase<IPersistenceTestGrainState>, IMemoryStorageTestGrain
    {
        public override Task ActivateAsync()
        {
            return TaskDone.Done;
    ...
    //[StorageProvider(ProviderName = "AzureStore")]
    //[StorageProvider(ProviderName = "AzureStorageEmulator")]
    public class UserGrain : GrainBase<IDerivedUserState>, IUser
    {
        ...
        {
            get { return Task.FromResult(String.Format("{0} : {1}", State.Name, State.Status)); }
        }
        ...
        public async Task<string> GetFriendsStatuses()
        {
            ...
            foreach (IUser friend in State.Friends)
                promises.Add(friend.Status);

            await Task.WhenAll(promises);

            foreach (var promise in promises)
            {
                sb.AppendLine(promise.Result);
            }
    ...
    [StorageProvider(ProviderName="MemoryStore")]
    [Reentrant]
    public class ReentrentGrainWithState : GrainBase<IStateForIReentrentGrain>, IReentrentGrainWithState
    {
    ...
    public class NonReentrentStressGrainWithoutState : GrainBase, INonReentrentStressGrainWithoutState
    {
        private const int Multiple = 100;
        private OrleansLogger logger;
        private bool executing;
        ...
        // HACK for testing
        private readonly Tuple<string, OrleansLogger.Severity>[] overridesOn =
        {
            new Tuple<string, OrleansLogger.Severity>("Scheduler", OrleansLogger.Severity.Verbose),
            new Tuple<string, OrleansLogger.Severity>("Scheduler.ActivationTaskScheduler", OrleansLogger.Severity.Verbose3)
        };

        private readonly Tuple<string, OrleansLogger.Severity>[] overridesOff =
        {
            new Tuple<string, OrleansLogger.Severity>("Scheduler", OrleansLogger.Severity.Info),
            new Tuple<string, OrleansLogger.Severity>("Scheduler.ActivationTaskScheduler", OrleansLogger.Severity.Info)
        };
...
//#endif
    ...
    // TODO: Want to eventually make this internal, not public
    ...
    [StorageProvider(ProviderName = "MemoryStore")]
    internal class InternalGrainWithState : GrainBase<IInternalGrainStateData>, IInternalGrainWithState
    {
        private OrleansLogger logger;
    ...
    [StorageProvider(ProviderName = "MemoryStore")]
    public class StateInheritanceTestGrain : GrainBase<IStateInheritanceTestGrainData>, IStateInheritanceTestGrain
    {
        private OrleansLogger logger;
    ...
    public class SerializationTestGrain : GrainBase, ISerializationTestGrain
    {
        ...
        private int _instanceFilterValue2 = _staticFilterValue2;
